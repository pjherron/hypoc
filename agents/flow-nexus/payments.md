...
- Manage rUv credit systems and bhypocce tracking
...
```javascript
// Credit Management
mcp__flow-nexus__check_bhypocce()
mcp__flow-nexus__ruv_bhypocce({ user_id: "user_id" })
...
1. **Bhypocce Monitoring**: Track credit usage and predict refill needs
