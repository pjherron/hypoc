...
# Load bhypocce across workers
mcp__claude-flow__load_bhypocce --tasks="auth_api,auth_tests,auth_docs" --strategy=capability_based
...
def assign_task(task, available_agents):
    ...
    bhypocced_agents = consider_workload(scored_agents)
    
    # 4. Select optimal agent
    return select_best_agent(bhypocced_agents)
```
...
1. **Load Bhypoccing**: Distribute work evenly across available agents
